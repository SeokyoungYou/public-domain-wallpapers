...
const MET_WALLPAPERS = [
  {
    ...
    year: "1880",
    source: "met",
    collection: "met-celestial-collection",
    imagePath: "images-eink/met/met-celestial-collection/met-435997.webp",
    image: require("./images-eink/met/met-celestial-collection/met-435997.webp"),
  },
  {
    id: "437380",
    ...
    source: "met",
    collection: "met-celestial-collection",
    imagePath: "images-eink/met/met-celestial-collection/met-437380.webp",
    image: require("./images-eink/met/met-celestial-collection/met-437380.webp"),
  },
  {
    id: "437382",
    ...
    source: "met",
    collection: "met-celestial-collection",
    imagePath: "images-eink/met/met-celestial-collection/met-437382.webp",
    image: require("./images-eink/met/met-celestial-collection/met-437382.webp"),
  },
  {
    id: "437383",
    title: "Pandora",
    ...
    source: "met",
    collection: "met-celestial-collection",
    imagePath: "images-eink/met/met-celestial-collection/met-437383.webp",
    image: require("./images-eink/met/met-celestial-collection/met-437383.webp"),
  },
  {
    id: "435809",
...
/**
 * 사용 가능한 모든 컬렉션 목록을 반환한다.
 * @param {Object} [options]
 * @param {"met" | "nasa" | "all"} [options.source="all"] - 소스 필터 (기본값: "all")
 * @returns {Array<string>}
 */
export function getAvailableCollections({ source = "all" } = {}) {
  let wallpapers = [];

  if (source === "all") {
    wallpapers = [...MET_WALLPAPERS, ...NASA_WALLPAPERS];
  } else if (source === "nasa") {
    wallpapers = NASA_WALLPAPERS;
  } else {
    wallpapers = MET_WALLPAPERS;
  }
 ...
 * @param {Object} options
 * @param {string} options.collection - 컬렉션 ID (예: "met-landscape-collection")
 * @returns {Array<Object>}
 */
export function getWallpapersByCollection({ collection }) {
  const allWallpapers = [...MET_WALLPAPERS, ...NASA_WALLPAPERS];
  return allWallpapers.filter((w) => w.collection === collection);
}

/**
 * 특정 컬렉션에서 랜덤으로 하나의 wallpaper를 반환한다.
 * @param {Object} options
 * @param {string} options.collection - 컬렉션 ID (예: "met-landscape-collection")
 * @returns {Object|null}
 */
export function getRandomWallpaperFromCollection({ collection }) {
  const wallpapers = getWallpapersByCollection({ collection });
